    ...
    try {
      ...
      if (data.meta) {
        console.log('Sync info:', {
          totalTweets: data.meta.result_count,
          deletedTweets: data.meta.deleted_count
        });
      }
    } catch (err: unknown) {
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">Your Timeline</h2>
              <p className="text-gray-500 text-sm">AI-Powered Analysis • Database Synced</p>
            </div>
            <button
              onClick={fetchTweets}
              disabled={loading}
          ...
          {error && (
            <div className="mb-6 bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                <div className="text-red-400 font-medium mb-1">Error Loading Tweets</div>
          ...
          {loading && tweets.length === 0 && (
            <div className="text-center py-16">
              <Loader2 className="w-10 h-10 animate-spin text-blue-500 mx-auto mb-4" />
              <p className="text-gray-500">Loading and syncing tweets...</p>
            </div>
          )}
          ...
          {!loading && tweets.length === 0 && !error && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 text-sm">Start by posting your first tweet!</p>
            </div>
          )}
